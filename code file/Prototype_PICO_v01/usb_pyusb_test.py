...
def oled_display(msg0, msg1, msg2, msg3, msg4, msg5, msg6):
    ...
    for i in range(1):
        ...
        #i2c.stop
        utime.sleep(0.1)                  # Display last for a time
        



def PWM_drive(angle, latency, lastduty):
    #duty0 = lastduty0
    #duty1,duty3,duty5,duty7 = lastduty1,lastduty3,lastduty5,lastduty7
    #duty2,duty4,duty6,duty8 = lastduty2,lastduty4,lastduty6,lastduty8
    duty = lastduty
    ...
    while abs(duty - setduty) > 60 : # servo dead_zone=5us, so shall >5LSB @LSB=3.2768 bit/us
        ...
        sleep_us(latency)     # using this dont forget import utime(not from utime import sleep)
